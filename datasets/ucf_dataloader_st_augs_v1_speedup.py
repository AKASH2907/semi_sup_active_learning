...
class UCF101DataLoader(Dataset):
    ...
    def get_det_annots_prepared(self, file_id):
        ...
        training_annot_file = "data_lists/" + str(file_id)
...
if __name__ == '__main__':
    ...
    if test_mode=="train":    
        dataset = UCF101DataLoader('train', [224, 224], 16, file_id='train_annots_90_unlabeled.pkl', aug_mode=0, subset_seed=47)
        ...
        dataset = UCF101DataLoader('test', [224, 224], 32, file_id='train_annots_10_labeled.pkl')
